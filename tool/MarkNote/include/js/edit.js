...
function doLayout(){
	...
	document.getElementById("editor-move").style.left  = (winw-240)  + "px";
	document.getElementById("editor-ace").style.width = (winw-240) -80 + "px";
	document.getElementById("editor-show").style.width = (winw-240) -53 + "px";
	document.getElementById("editor-show").style.marginLeft = (winw-240) + 5 + "px";
