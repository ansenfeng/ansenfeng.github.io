...
Core.menu={
    ...
    [{
        ...
        data: [[{
            text: "背景1",
            func: function() {
                $(this).attr("style",'background:url(images/background.jpg) repeat;');
            }
        }, {
            text: "背景2",
            func: function() {
...
Core.init = function(){
    ...
    $("#desk").bind('contextmenu',function(){
        $(".popup-menu").hide();
        $("#desk").smartMenu(Core.menu.bodymenudataB, {
            name: "body"    
        });
    ...
    //绑定快捷方式点击事件
    ul.find('li').live('dblclick',function(){
        Core.create($(this));
    });
    //绑定任务栏点击事件
